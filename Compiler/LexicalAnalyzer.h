...
//
//public:
//    LexicalAnalyzer(const std::string& input, const LexicalAutomaton& lexerAutomaton)
//        : inputString(input), automaton(lexerAutomaton), inputIndex(0), recognizedTokens(NULL){}
//
//    void _BOOT_() {
...
//                            }
//                            else {
//                                it = tokenLookupTable.find("''str_literal''");
//                            }
//                        }
//                        this->inputIndex++;
//                    }
